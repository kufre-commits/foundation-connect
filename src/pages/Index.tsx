...
const Index = () => {
  ...
  const hasRegistrants = registrants.filter((r) => r.formUploaded).length > 0;
        ...
        <div className="relative z-10 container text-center px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-primary-foreground/80 max-w-2xl mx-auto mb-4 font-body">
              We believe everyone deserves a chance at financial stability. Our
              foundation is dedicated to empowering lives through direct
              financial support.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/register">
                <Button
                  size="lg"
                  className="gold-gradient text-secondary-foreground font-semibold text-base px-8 py-6 hover:opacity-90 transition-opacity"
                >
                  Register Now
            ...
            {[
              {
                icon: HandHeart,
                title: "Register",
                desc: "Fill out a simple registration form with your details to get started.",
              },
              {
                icon: Award,
                title: "Download & Upload",
                desc: "Download your registration form as a PDF and upload it to confirm your entry.",
              },
              {
                icon: Users,
                title: "Get Selected",
                desc: "Our Top 10 Favorites receive direct financial support from the foundation.",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
